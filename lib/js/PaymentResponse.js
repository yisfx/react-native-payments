...
export default class PaymentResponse {
  ...
  constructor(paymentResponse: Object) {
    ...
    this._payerName = paymentResponse.details.payerName;
    this._payerPhone = paymentResponse.details.payerPhone;
    this._payerEmail = paymentResponse.payerEmail;
    this._shippingAddress.addressLine=paymentResponse.details.addressLine;
    // Internal Slots
  ...
  complete(paymentStatus: PaymentComplete,callback:Function) {
    ...
    let result= new Promise(function(resolve, reject){
      ...
      NativePayments.complete(paymentStatus,callback);
    });
